...
COPY .docker/etc/supervisord/supervisord.conf /etc/supervisord/supervisor.conf
COPY .docker/s6/cont-init.d/00-worker-build.sh .docker/s6/cont-init.d/01-std-stream-permissions.sh .docker/s6/cont-init.d/01-worker-pidfile-permissions.sh .docker/s6/cont-init.d/99-start-message.sh /etc/cont-init.d/
