...
<p>
    I've <a href="http://weierophinney.net/matthew/archives/176-Zend-Framework-Dojo-Integration.html">blogged</a>
    <a href="http://weierophinney.net/matthew/archives/178-Zend-FrameworkDojo-Integration-QA-Slides.html">a
    number of times</a> about this, but a picture is worth a thousand words... or lines of code, in
...
<a href="/uploads/dojoDemo-2008-08-11.png">
    <img src="http://weierophinney.net/uploads/dojoDemo-2008-08-11.png"
        width="650" border="0" alt="Dojo and ZF integration at work" />
</a>
...
<a href="/uploads/gridDemo-2008-08-11.png">
    <img src="http://weierophinney.net/uploads/gridDemo-2008-08-11.png"
        width="650" alt="Dojo and ZF playing nice and creating grids" border="0" />
</a>
...
<p>
    I've also
    <a href="http://weierophinney.net/matthew/archives/182-Testing-Zend-Framework-MVC-Applications.html">blogged
    about this before</a>. 
...
<p>
    ...
    received community contributions of
    <a href="http://framework.zend.com/manual/en/zend.text.html#zend.text.figlet">Figlet</a>
...
<p>
    ...
    things with it. He has even created a
    <a href="http://framework.zend.com/wiki/display/ZFDEV/Zend_Soap_Client+compatibility+matrix">compatibility
    matrix</a> that users can update to show how WSDL autodiscovery works with various SOAP
