...
$entry->setId('2015-09-09-composer-root');
$entry->setTitle('Fixing Version Issues When Running Composer from a Branch');
$entry->setAuthor($author);
$entry->setDraft(false);
$entry->setPublic(true);
$entry->setCreated(new \DateTime('2015-09-09 09:10', new \DateTimezone('America/Chicago')));
$entry->setUpdated(new \DateTime('2015-09-09 09:10', new \DateTimezone('America/Chicago')));
