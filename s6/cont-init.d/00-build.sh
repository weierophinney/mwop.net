...
chgrp zendphp data/github-feed.json data/homepage.posts.json data/comics.phtml
chmod g+rw data/github-feed.json data/homepage.posts.json data/comics.phtml
