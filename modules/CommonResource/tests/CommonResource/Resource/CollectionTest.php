<?php
namespace CommonResource\Resource;
...
class CollectionTest extends TestCase
{
    ...
    {
        $items      = $this->getItems();
        $collection = new Collection($items, 'CommonResource\Resource\TestAsset\TestEntity');
        $i          = 0;
    ...
    public function testIteratingOverCollectionReturnsObjectsOfSpecifiedClass()
    {
        ...
        $i          = 0;
        foreach ($collection as $item) {
            $this->assertInstanceOf('CommonResource\Resource\TestAsset\TestEntity', $item);
        }
    }
}
