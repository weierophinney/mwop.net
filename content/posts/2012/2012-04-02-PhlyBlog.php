...
$date = new \DateTime('2012-04-03 08:45', new \DateTimezone('America/Chicago'));
...
<p>
    ...
    technically houses just my blog.)
</p>
...
<p>
    ...
    dropy in a small amount of markup into your post <em>once</em> -- meaning
...
<p>
    ...
    have <code>fromArray()</code> and <code>toArray()</code> methods to allow
...
<p>
    I eventually added an "Author" entity. I realized I would like to re-use
    mainly to re-use this code in places where we could potentially have
    multiple authors (such as the <a href="http://framework.zend.com/zf2/blog">ZF2 blog</a>).
...
<ul>
    ...
    <li>I create a new branch off my development branch: <code>git checkout -b post/blahblah develop</code></li>
    <li>I start editing a "post" file: <code>vim content/some-new-post.php</code></li>
    ...
    <li>I merge it back to my development branch, and generate my blog. (I have a CLI tool for this: <code>./console 
