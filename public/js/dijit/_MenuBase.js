...
return _e.parentNode==this.containerNode;
},postCreate:function(){
var _f=this,_10=typeof this.childSelector=="string"?this.childSelector:_6.hitch(this,"childSelector");
this.own(on(this.containerNode,on.selector(_10,_7.enter),function(){
_f.onItemHover(_a.byNode(this));
}),on(this.containerNode,on.selector(_10,_7.leave),function(){
_f.onItemUnhover(_a.byNode(this));
}),on(this.containerNode,on.selector(_10,_9),function(evt){
_f.onItemClick(_a.byNode(this),evt);
evt.stopPropagation();
evt.preventDefault();
}));
